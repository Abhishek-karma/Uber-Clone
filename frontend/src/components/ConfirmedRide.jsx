...
const ConfirmedRide = (props) => {
  return (
    <div>
      ...
      <h3 className="mt-5 font-semibold text-2xl">Confirm your Ride</h3>
      ...
      <div className="mt-5 flex gap-2 justify-between items-center flex-col">
        ...
        className="flex mt-4 w-full flex-col items-center bg-slate-600 text-white text-2xl rounded-lg p-2  font-semibold">
          Confirm
        </button>
      </div>
    </div>
